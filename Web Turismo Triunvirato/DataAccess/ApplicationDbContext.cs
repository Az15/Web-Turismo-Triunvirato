...
namespace Web_Turismo_Triunvirato.DataAccess
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public async Task AbmHotelPromotionAsync(HotelPromotion promotion, string typeExecuted)
        {
           ...
           string sql = "CALL SetActivePromotionHotels(@p_id, @p_servicetype, @p_description,@p_whatsapp_id, @p_destinationname,  " +
           "@p_hotelname, @p_imageurl, @p_ishotweek, @p_originalprice, @p_offerprice, @p_discountpercentage, @p_startdate, @p_enddate, @p_isactive, @p_stars, @p_typeexecuted)";
